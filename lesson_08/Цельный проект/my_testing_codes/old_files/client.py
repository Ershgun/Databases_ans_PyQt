...
from lesson_08.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_08.common.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_08.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_08.common.metaclasses import ClientMaker
from lesson_08.my_testing_codes.old_files.client_database import ClientDatabase
