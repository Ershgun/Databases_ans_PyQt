...
from lesson_08.client.main_window_conv import Ui_MainClientWindow
from lesson_08.client.add_contact import AddContactDialog
from lesson_08.client.del_contact import DelContactDialog
