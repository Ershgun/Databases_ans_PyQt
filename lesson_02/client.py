...
from lesson_02.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_02.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_02.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_02.metaclasses import ClientMaker
